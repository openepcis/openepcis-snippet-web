<template>
  <div class="space-y-4">
    ...
    <div class="flex items-center gap-2">
      <UIcon name="i-heroicons-link" class="w-4 h-4 text-red-500" />
      <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
        URI Array Validation
      </h4>
    </div>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-red-600 dark:text-red-300 mt-1">
              Each array item accepts any valid URI format (e.g., urn:uuid:...,
              ni:///sha-256;..., https://example.com/event/123).
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-blue-600 dark:text-blue-300 mt-1">
              Provide a regular expression pattern to validate each URI in the array.
            </p>
          </div>
        </div>
      </div>
...
import type { UriArrayConfig } from "~/types/profile";
...
const emit = defineEmits<{
  (e: "update:uriArrayConfig", value: UriArrayConfig): void;
}>();
...
// Example regex patterns for event IDs
